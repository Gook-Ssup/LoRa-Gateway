...
class charm_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.loraGS_lora_preamble_detect_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.loraGS_weak_lora_detect_0, 0), (self.qtgui_time_sink_x_0_0, 0))
